 ...
 */
const MouseLeave: FC<MouseLeaveProps> = forwardRef(
  ({ active = true, onMouseLeave, children }, forwardedRef) => {
    ...
    const handleClick = (event: any) => {
       ...
       * MouseLeave component, if not, Outside clicked! Fire onClick cb
       */
...
MouseLeave.displayName = 'MouseLeave';
